...
<body class="is-preload">
	...
	<form action="../sessionManager" method="post" accept-charset="UTF-8">
	...
	<div class="container buttoncenter">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<form action="PasswordRestore.jsp" method="get">
		  				<button class="btn btn-secondary">Restablecer Contraseña</button>
					</form>
				</div>
